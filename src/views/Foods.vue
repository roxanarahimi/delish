<template>
  <!--      top nav -->
  <div class="w-100 pt-4 pb-4  d-flex justify-content-center" style="position: fixed; z-index: 100; background-color: white !important ;">
      ...
      <div class="d-flex justify-content-center ">
        ...
        <div id="content" class="col-9 col-md-10 row " style="">
          ...
          <div id="factor" class="d-none d-xl-block row col-4 px-2 mb-3">
            ...
            <img style="position: fixed; left: 350px; width: 350px; bottom: 0px" src="../assets/chef1.png" alt="">
